...
.v1 {
	background-image: url(../index/img/k1.jpg);
}
.img {
	text-align: center;
}
...
<!-- *********************************************** -->
 ...
 <div class="d_1 v1">
    <header>
     <img src="../images/tra.png" width="600px"></a><br><br>
...
<table>
   <TR>
   <TH>
   <a href="../index.jsp"><img src="../index/img/f1.jpg" width="500px"></a>&nbsp;&nbsp;</TH>
   <TD>
   <a href="../index.jsp"><img src="../index/img/f2.jpg" width="500px"></a></TD>
   </TR>
   <tr>
   ...
   <tr>
   <td>제 손을 잡아 주셨죠.<br>제가 손 잡아 드릴게요. </td>
   <td>가족들이 서로 맺어져 하나가 되어 있다는 것이<br>정말 이 세상에서의 유일한 행복이다. </td>
   </tr>
   <tr>
   <td><a href="../index.jsp">효도여행은 진식투어와 함께</a></td>
   <td><a href="../index.jsp">가족여행은 진식투어와 함께</a></td>
   </tr>
      </table>
