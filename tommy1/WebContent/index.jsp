		...
		<div class="carousel slide" id="photo">
			...
			<div class="carousel-inner">
				<div class="item active"><a href="<%=root%>/info/lb.jsp">
					<img id="img" src="./menu/images/paris1.jpg" width="1300px"align="center"></a>
				...
				<div class="item"><a href="https://en.wikipedia.org/wiki/Shanghai">
					<img id="img" src="./menu/images/shanghai.jpg"width="1300px"  align="center"></a>
					<div class="carousel-caption">
						<h4>Shanghai</h4>
				...
				<div class="item"><a href="https://en.wikipedia.org/wiki/New_York">
					<img id="img" src="./menu/images/newyork.jpg"width="1300px"align="center"></a>
					<div class="carousel-caption">
						<h4>New York</h4>
